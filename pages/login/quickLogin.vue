		...
		<view class="login-box">
			<view class="login-img">
				...
				<view class="login-appname">
					<text>欢迎进入海贝记账</text>
					<text class="small-text">输入手机号快捷登录</text>
				</view>
			</view>
			<view class="login-input">
				...
				<view class="login-password">
					<view class="">
						...
						<view class="login-username">
							<input type="number" v-model="code" value="" placeholder="请输入验证码"/>
						</view>
					</view>
			...
			<view class="login-btn" @click="goQuickLogin()">
				<text>立即登录</text>
			</view>
		</view>
	</view>
...
<script>
	...
	import {getCode,checkMobile,checkInt,checkNull} from "../../components/shield.js";
	...
	export default {
		...
		methods: {
			...
			goQuickLogin(){
				...
				// 检验验证码是否正确
				if(that.code != that.codeNumber){
					showInfo("验证码错误");
				}else{
					uni.request({
						url:app.globalData.http+"admin/login/appphonelogin",
						data:{
							phone:mobile,
							x:'yunyou'
						},
